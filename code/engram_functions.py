...
def tally_layout_bigram_rolls(layout, bigrams, bigram_frequencies, verbose=False):
    """
    ...
    bigram_rolls, bigram_roll_counts, bigram_rolls_total = tally_layout_bigram_rolls(layout, bigrams, bigram_frequencies, verbose=True)
    """   
    #    1  2  3  4   13 14 15 16  
    #    5  6  7  8   17 18 19 20 
    #    9 10 11 12   21 22 23 24
...
def print_layout24_instances(layout, letters24, instances24, bigrams, bigram_frequencies):
    ...
    tally_layout_bigram_rolls(layout, bigrams, bigram_frequencies, verbose=True)
